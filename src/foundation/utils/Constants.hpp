...
public:
  ...
  static constexpr types::Real SOUND_SPEED_AIR = 343.0;         // m/s at 20°C
  static constexpr types::Real AIR_DENSITY = 1.225;             // kg/m³ at 20°C
  static constexpr types::Real AIR_IMPEDANCE = 415.275;         // Pa⋅s/m (ρc)
  static constexpr types::Real ATMOSPHERIC_PRESSURE = 101325.0; // Pa
  ...
  // Static class, no initialization - it is just a namespace-like container
  Constants() = delete;
